    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-8">
                ...
                <h5 class="header-title"><small>Ombor nomi:</small>  <?=$model->name?></h5>
                  <h6> <small>Address:  <?=$model->adress?></small></h6>
                  <h6> <small>Ma'lumot:  <?=$model->note?></small></h6>
            </div>
            <div class="col-lg-4">
                <?= Html::a('<i class="fa fa-edit"></i>', ['update-wherehouse-group', 'id' => $model->id], ['class' => 'btn btn-primary pull-right']) ?>
                <?= Html::a('<i class="fa fa-trash"></i>', ['delete-wherehouse-group', 'id' => $model->id], [
