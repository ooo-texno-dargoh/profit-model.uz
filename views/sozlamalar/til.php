...
<div class="main-card card">
    <div class="card-body">
                <a href="<?=Yii::$app->urlManager->createUrl(['/sozlamalar/add-til'])?>" class="pull-right btn btn-success"><i class="fa fa-plus-square"></i></a>
...
//                        'status',
                        [
                            ...
                            'value'=>function($x){
                                ...
                                return Html::a(Yii::t('app', '<span class="fa fa-exclamation"></span>  '), ['/sozlamalar/change-status-lang','id'=>$x->id], [
                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a(Yii::t('app', '<span class="fa fa-trash"></span>  '), ['delete-til', 'id' => $model->id], [
                                        'class' => 'mb-2 mr-2 border-0 btn-transition btn btn-outline-danger',
                                        'data' => [
